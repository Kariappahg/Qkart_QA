...
public class Qkart_project extends BaseClass {
	Qkart_POM q;
...
//	}
	...
	public void setUp(@Optional("chrome") String browserName) throws Exception {
	    launchBrowser(browserName); // Launch the browser
	    q = new Qkart_POM(driver); // Initialize the page object
	    Thread.sleep(1500);
	}
